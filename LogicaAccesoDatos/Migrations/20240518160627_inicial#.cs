        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Obras_Empleados_EmpleadoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ObraIdObra1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Materiales_Obras_ObraIdObra1",
                        column: x => x.ObraIdObra1,
                        principalTable: "Obras",
                        principalColumn: "IdObra");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Planos_Obras_ObraIdObra",
                        column: x => x.ObraIdObra,
                        principalTable: "Obras",
                        principalColumn: "IdObra");
                    table.ForeignKey(
                        name: "FK_Planos_TiposPlanos_IdPlano",
                        column: x => x.IdPlano,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Materiales_ObraIdObra1",
                table: "Materiales",
                column: "ObraIdObra1");

            migrationBuilder.CreateIndex(
                name: "IX_Obras_EmpleadoId",
                table: "Obras",
                column: "EmpleadoId");

            migrationBuilder.CreateIndex(
                name: "IX_Planos_IdPlano",
                table: "Planos",
                column: "IdPlano");

            migrationBuilder.CreateIndex(
                name: "IX_Planos_ObraIdObra",
                table: "Planos",
                column: "ObraIdObra");
